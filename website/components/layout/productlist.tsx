// website/src/components/shared/ProductList.tsx
"use client";
  ...
  return (
    <section className="bg-white py-6 ">
      <div className="mx-auto max-w-350 px-4">
        ...
        {/* Carousel Outer Track Boundary */}
        <div className="relative">
          
          {/* 🛠️ LEFT ARROW: Now permanently visible and interactive */}
          <button
            onClick={scrollPrev}
          ...
          {/* 🛠️ RIGHT ARROW: Now permanently visible and interactive */}
          <button
            onClick={scrollNext}
